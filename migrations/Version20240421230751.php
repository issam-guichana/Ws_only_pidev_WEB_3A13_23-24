 ...
 */
final class Version20240421230751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(250) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE mdp mdp VARCHAR(255) DEFAULT NULL, CHANGE age age INT DEFAULT NULL, CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE gender gender VARCHAR(50) DEFAULT NULL, CHANGE image image VARCHAR(500) DEFAULT NULL, CHANGE status status INT DEFAULT 1 COMMENT \'Active=1 Inactive=0\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(250) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE mdp mdp VARCHAR(255) NOT NULL, CHANGE age age INT NOT NULL, CHANGE role role VARCHAR(255) NOT NULL, CHANGE gender gender VARCHAR(50) NOT NULL, CHANGE image image VARCHAR(500) NOT NULL, CHANGE status status INT DEFAULT 1 NOT NULL COMMENT \'Active=1 Inactive=0\'');
        ...
        $this->addSql('ALTER TABLE user_formation CHANGE user_id user_id INT NOT NULL, CHANGE form_id form_id INT NOT NULL, CHANGE certif_id certif_id INT NOT NULL');
