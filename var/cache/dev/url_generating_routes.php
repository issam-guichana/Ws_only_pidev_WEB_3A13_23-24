...
return [
    ...
    'generate_event_pdf' => [['id'], ['_controller' => 'App\\Controller\\PdfController::generateEventPdf'], [], [['text', '/generate-pdf'], ['variable', '/', '[^/]++', 'id', true], ['text', '/event']], [], [], []],
    ...
    'app_search' => [[], ['_controller' => 'App\\Controller\\TestController::search'], [], [['text', '/search']], [], [], []],
    'apply_event' => [['id'], ['_controller' => 'App\\Controller\\TestController::applyEvent'], [], [['text', '/apply'], ['variable', '/', '[^/]++', 'id', true], ['text', '/event']], [], [], []],
    'verify_event_code' => [['id'], ['_controller' => 'App\\Controller\\TestController::verifyEventCode'], [], [['text', '/verify'], ['variable', '/', '[^/]++', 'id', true], ['text', '/event']], [], [], []],
    'stripe_payment' => [['id'], ['_controller' => 'App\\Controller\\TestController::processStripePayment'], [], [['text', '/payment'], ['variable', '/', '[^/]++', 'id', true], ['text', '/event']], [], [], []],
    'success_page' => [['id'], ['_controller' => 'App\\Controller\\TestController::successPage'], [], [['text', '/success'], ['variable', '/', '[^/]++', 'id', true], ['text', '/event']], [], [], []],
