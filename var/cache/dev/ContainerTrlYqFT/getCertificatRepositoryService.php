 ...
 */
class getCertificatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CertificatRepository' shared autowired service.
     *
     * @return \App\Repository\CertificatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CertificatRepository.php';

        return $container->privates['App\\Repository\\CertificatRepository'] = new \App\Repository\CertificatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
