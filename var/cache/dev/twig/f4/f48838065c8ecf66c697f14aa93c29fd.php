...
class __TwigTemplate_018002ff5504975e3ae721df6ead8a3d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<a class=\"sidebar-link\" href=\"admin.html.twig\">
              <i class=\"align-middle\" data-feather=\"sliders\"></i> <span class=\"align-middle\">Badge</span>
            </a>
\t\t\t\t\t</li>
...
\t\t\t\t\t<h1 class=\"h3 mb-3\"><strong>Badges</strong></h1>
...
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col mt-0\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"card-title\">Totale des Badge</h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col mt-0\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"card-title\">Top Badges</h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col mt-0\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"card-title\">Badges Attribués</h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t<h5 class=\"card-title mb-0\">Badges/Mois</h5>
\t\t\t\t\t\t\t\t</div>
...
\t</script>
    ...
    <div class=\"card-header\">
        ...
        echo "\" class=\"btn btn-primary\">Ajouter une badge</a>
            </div>
        </div>
    </div>
                    <div class=\"card-body\">
...
\t\t\t\t\t\t\t\t\t\t <th>Modifier</th>
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["badges"]) || array_key_exists("badges", $context) ? $context["badges"] : (function () { throw new RuntimeError('Variable "badges" does not exist.', 374, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["badge"]) {
            // line 375
            echo "        <tr>
            <td>";
            // line 376
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["badge"], "nomBadge", [], "any", false, false, false, 376), "html", null, true);
            echo "</td>
            <td>";
            // line 377
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["badge"], "type", [], "any", false, false, false, 377), "html", null, true);
            echo "</td>
            <td>";
            // line 378
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["badge"], "imgBadge", [], "any", false, false, false, 378), "html", null, true);
            echo "</td>
           ...
           <td>
                <form action=\"";
            // line 383
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_badge_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["badge"], "id", [], "any", false, false, false, 383)]), "html", null, true);
            echo "\" method=\"POST\" onsubmit=\"return confirm('Are you sure you want to delete this badge?');\">
                    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
                    <input type=\"hidden\" name=\"_token\" value=\"";
            // line 385
            echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, $context["badge"], "id", [], "any", false, false, false, 385))), "html", null, true);
            echo "\">
...
\t\t\t<td>
                <form action=\"";
            // line 391
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_Badge_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["badge"], "id", [], "any", false, false, false, 391)]), "html", null, true);
            echo "\" method=\"POST\" ;\">
                    <input type=\"hidden\" name=\"_method\" value=\"edit\">
                    <input type=\"hidden\" name=\"_token\" value=\"";
            // line 393
            echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("edit" . twig_get_attribute($this->env, $this->source, $context["badge"], "id", [], "any", false, false, false, 393))), "html", null, true);
            echo "\">
...
";
    ...
    {
        return array (  756 => 401,  742 => 393,  737 => 391,  728 => 385,  723 => 383,  715 => 378,  711 => 377,  707 => 376,  704 => 375,  700 => 374,  679 => 356,  665 => 344,  655 => 343,  418 => 418,  408 => 410,  406 => 343,  275 => 215,  251 => 194,  236 => 182,  221 => 170,  67 => 19,  58 => 13,  44 => 1,);
    }
...
\t\t\t\t\t{% block body %}
    ...
    <div class=\"card-header\">
        <div class=\"row justify-content-between align-items-center\">
            ...
            <div class=\"col-auto\">
                <a href=\"{{ path('app_badge_new') }}\" class=\"btn btn-primary\">Ajouter une badge</a>
            </div>
        </div>
    </div>
                    <div class=\"card-body\">
...
\t\t\t\t\t\t\t\t\t\t <th>Modifier</th>
    ...
    {% for badge in badges %}
        <tr>
            ...
            <td>{{ badge.type }}</td>
            <td>{{ badge.imgBadge }}</td>
            

           
           <td>
                <form action=\"{{ path('app_badge_delete', {'id': badge.id}) }}\" method=\"POST\" onsubmit=\"return confirm('Are you sure you want to delete this badge?');\">
                    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
...
\t\t\t<td>
                <form action=\"{{ path('app_Badge_edit', {'id': badge.id}) }}\" method=\"POST\" ;\">
                    <input type=\"hidden\" name=\"_method\" value=\"edit\">
                    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('edit' ~ badge.id) }}\">
                    <button type=\"submit\" class=\"btn btn-danger\">edit</button>
                </form>
            </td>
...
</html>", "badge/index.html.twig", "C:\\Users\\rymra\\IdeaProjects\\formini.tn\\templates\\badge\\index.html.twig");
    }
}
