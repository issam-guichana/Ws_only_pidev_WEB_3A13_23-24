...
class __TwigTemplate_934c17af8c24217a78e397731589d437 extends Template
{
    private $source;
    private $macros = [];
...
\t<script src=\"";
    ...
    {
        return array (  142 => 74,  124 => 59,  114 => 52,  110 => 51,  103 => 47,  99 => 46,  93 => 43,  66 => 19,  57 => 13,  43 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t<form method=\"post\">
    ...
    {{ form_start(form) }}
                    ...
                    <div class=\"mb-3\">
                      ...
                      {{ form_widget(form.nomCertif, {'attr': {'class': 'form-control form-control-lg'}}) }}
                    </div>

                    <div class=\"mb-3\">
                      {{ form_label(form.dateCertif, 'Date du certificat') }}
                      {{ form_widget(form.dateCertif, {'attr': {'class': 'form-control form-control-lg'}}) }}
                    </div>
...
</html>", "certificat/edit.html.twig", "C:\\Users\\rymra\\IdeaProjects\\formini.tn\\templates\\certificat\\edit.html.twig");
    }
}
